<?php
    $topNav = '<a href="/" class="active">WHAT\'S NEW</a>|<a href="/whats-great">WHAT\'S GREAT</a>|<a href="/video-tutorials">VIDEO TUTORIALS</a>';
    $footer = '<a href="/whats-great">WHAT\'S GREAT!</a>|<a href="/video-tutorials">VIDEO TUTORIALS</a>';
...
<div id="Page">
    ...
    <div id="New" class="blockWrap">
        <div class="blockContent">
            <div class="blockSection">
                <iframe width="450" height="300" src="https://www.youtube.com/embed/UDYiAGEWcNs" frameborder="0" allowfullscreen></iframe>
            </div>
            <div class="blockSection">
    ...
    <div id="Royalty" class="blockWrap">
        <div class="blockContent">
            ...
            <div class="blockSection">
                <h5>Choose from many different categories</h5>
                <div class="col65">
                    <div class="col50">
                        <ul>
